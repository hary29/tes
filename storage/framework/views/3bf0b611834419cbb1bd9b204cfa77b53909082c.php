<?php $__env->startSection('tittle','Donation'); ?>
...
<section class="container-fluid mt-5 mb-3">
    <div class="p-3 bg-white">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 text-center my-5">
                <img src="<?php echo e(asset('/img/donation.jpg')); ?>" class="w-100" alt="donation">
            </div>
        </div>
        ...
        <div class="row mt-5" id="transType">
            <div class="col-sm-3">
                <div class="card shadow p-3 mb-5 bg-white rounded">
                    <div class="card-body">
                        <a href="javascript:void(0)" class="modalMd" value="" title="Bank Transfer" page="dialog" ><img src="<?php echo e(asset('/img/icon/payment.jpg')); ?>" class="w-100" alt="payment"></a>
            ...
            <div class="col-sm-3">
                <div class="card shadow p-3 mb-5 bg-white rounded">
                    <div class="card-body">
                        <a href="javascript:void(0)" class="modalMd" value="" title="Go pay" page="dialog" ><img src="<?php echo e(asset('/img/icon/payment.jpg')); ?>" class="w-100" alt="payment"></a>
            ...
            <div class="col-sm-3">
                <div class="card shadow p-3 mb-5 bg-white rounded">
                    <div class="card-body">
                        <a href="javascript:void(0)" class="modalMd" value="" title="OVO" page="dialog" ><img src="<?php echo e(asset('/img/icon/payment.jpg')); ?>" class="w-100" alt="payment"></a>
            ...
            <div class="col-sm-3">
                <div class="card shadow p-3 mb-5 bg-white rounded">
                    <div class="card-body">
                        <a href="javascript:void(0)" class="modalMd" value="" title="Shopee Pay" page="dialog" ><img src="<?php echo e(asset('/img/icon/payment.jpg')); ?>" class="w-100" alt="payment"></a>
...
<div class="container-fluid p-3 my-3">
  <div class="btm-row-index">
    ...
    <?php echo $__env->make('layout/sliderTestimonial', ['datatestimony' => $dataTestimony], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        
    </div>
</div>
<?php } ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php74/tes/resources/views/site/donation.blade.php ENDPATH**/ ?>