        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            <form>
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        <div class="mb-4">
                            <label for="formPhoto" class="block text-gray-700 text-sm font-bold mb-2">photo :</label>
...
unset($__errorArgs, $__bag); ?>
                       ...
                       <!--  <div class="mb-4">
                            ...
                            <textarea class="ckeditor shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="formShortContent" wire:model="short_description"></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-2 bg-white" wire:ignore>
                          ...
                          <div
                               ...
                               "
                               wire:model.debounce.2000ms="short_description"
                          >
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if($oldPublishdate): ?>
                          <div class="mb-4">
                              <label for="formPublishDate" class="block text-gray-700 text-sm font-bold mb-2 mt-1">Publish Date:</label>
                              <input type="date" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="formPublishDate"wire:model="publish_date">
...
<?php /**PATH /var/www/html/php74/tes/resources/views/livewire/articleManage/create.blade.php ENDPATH**/ ?>