...
<section class="container-fluid mt-5 mb-3">
    <div class="p-3 bg-white">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 text-center my-5">
                <img src="{{ asset('public/img/donation.jpg')}}" class="w-100" alt="donation">
            </div>
        </div>
        ...
        <div class="row mt-5" id="transType">
            <div class="col-sm-3">
                <div class="card shadow p-3 mb-5 bg-white rounded">
                    <div class="card-body">
                        <a href="javascript:void(0)" class="modalMd" value="" title="Bank Transfer" target="dialog" ><img src="{{ asset('public/img/icon/payment.jpg')}}" class="w-100" alt="payment"></a>
            ...
            <div class="col-sm-3">
                <div class="card shadow p-3 mb-5 bg-white rounded">
                    <div class="card-body">
                        <a href="javascript:void(0)" class="modalMd" value="" title="Go pay" target="dialog" ><img src="{{ asset('public/img/icon/payment.jpg')}}" class="w-100" alt="payment"></a>
            ...
            <div class="col-sm-3">
                <div class="card shadow p-3 mb-5 bg-white rounded">
                    <div class="card-body">
                        <a href="javascript:void(0)" class="modalMd" value="" title="OVO" target="dialog" ><img src="{{ asset('public/img/icon/payment.jpg')}}" class="w-100" alt="payment"></a>
            ...
            <div class="col-sm-3">
                <div class="card shadow p-3 mb-5 bg-white rounded">
                    <div class="card-body">
                        <a href="javascript:void(0)" class="modalMd" value="" title="Shopee Pay" target="dialog" ><img src="{{ asset('public/img/icon/payment.jpg')}}" class="w-100" alt="payment"></a>
