        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            <form>
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        <div class="mb-4">
                            <label for="formPhoto" class="block text-gray-700 text-sm font-bold mb-2">photo url:</label>
                            <input type="file" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="formPhoto" wire:model="url_photo">

                             @error('url_photo') <span class="error">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            <label for="formPosition" class="block text-gray-700 text-sm font-bold mb-2">Position:</label>
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="formPosition" wire:model="position">
                            @error('position') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                        <div class="mb-4">
                            <label for="formLocation" class="block text-gray-700 text-sm font-bold mb-2">Position:</label>
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="formLocation" wire:model="location">
                            @error('location') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                       
                        <div class="mt-2 bg-white" wire:ignore>
                          <label for="description" class="block text-gray-700 text-sm font-bold mb-2">Content Testimony:</label>
                          <div
                               x-data
                               x-ref="quillEditor"
                               x-init="
                               ...
                               "
                               wire:model.debounce.2000ms="content_testimony"
                          >
                            {!! $content_testimony !!}
                          </div>
                        </div>
