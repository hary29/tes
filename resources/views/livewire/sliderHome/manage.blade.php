@section('tittle','Slider Home Manage')
<x-slot name="header">
...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl overflow-x-auto sm:rounded-lg px-4 py-4">
            ...
            <button wire:click="create()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">Tambah Slider Home</button>
            
            @if($isDetail)
                @include('livewire.sliderHome.detail')
            @elseif($isModal)
                @include('livewire.sliderHome.create')
            @endif
