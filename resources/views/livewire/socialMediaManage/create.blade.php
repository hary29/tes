            ...
            <form>
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        ...
                        <div class="mb-4">
                            <label for="formNameId" class="block text-gray-700 text-sm font-bold mb-2">Name Id:</label>
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="formNameId" wire:model="name_id">
                            @error('name_id') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>

                        <div class="mb-4">
                            <label for="formLink" class="block text-gray-700 text-sm font-bold mb-2">Url:</label>
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="formLink" wire:model="url">
                            @error('url') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>

                       <div class="mb-4">
                            <label for="formIcon" class="block text-gray-700 text-sm font-bold mb-2">Icon Class:</label>
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="formIcon" wire:model="icon_class">
                            @error('icon_class') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
