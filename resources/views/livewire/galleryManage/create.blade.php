            ...
            <form>
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                       ...
                       <div class="mb-4">
                            <label for="formEvent" class="block text-gray-700 text-sm font-bold mb-2 mt-1">Event Time:</label>
                            <input type="date" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="formEvent"wire:model="event_time">
                            @error('event_time') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
